...
When inserting into an empty LinkedList(beginning), you need to address the head and last_node first, then add nodes. If not empty, insert in the front by connecting the new node to the self.head()
